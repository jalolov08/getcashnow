...
import "./faqTabs.style.css";
import TabContentTitle from './TabContentTitle/tabContentTitle.component';
...
export default function FaqTabs() {
    ...
    return (
        <div className='tabs'>
            <Tabs>
                <TabList>
                    <Tab>Займы онлайн</Tab>
                    <Tab>Условия оформления</Tab>
                    <Tab>Ответственность за просрочку</Tab>
                    <Tab>Информация о кредиторах</Tab>
                </TabList>
                ...
                <TabPanel>
                    <div className='tab_content'>
                        ...
                        <div className='tab_cards_cont'>
                            {orgData.map((item) => {
                                return (
                                    <div className='tab_card' key={item.id}>
